    ...
    return (
      <div className={classNames({[style.navContainer]: true, [style.collapsed]: this.state.collapsed})}>
        ...
        <ul className={style.menu}>
          <li><a><i className={`${fontAwesome.fa} ${fontAwesome['fa-server']}`}></i><span className={style.menuItemText}>Clusters</span></a></li>
          <li><a><i className={`${fontAwesome.fa} ${fontAwesome['fa-users']}`}></i><span className={style.menuItemText}>Users</span></a></li>
          <li><a><i className={`${fontAwesome.fa} ${fontAwesome['fa-th-large']}`}></i><span className={style.menuItemText}>Services</span></a></li>
        </ul>
